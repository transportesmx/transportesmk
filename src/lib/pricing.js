...
export const vehiculos = [
  {
    ...
    descripcion: 'Jetta o similar',
    capacidadPasajeros: 3,
    capacidadEquipaje: 3,
    imagen: '/assets/autos/sedan.png',
    kmMinimo: 10,
    precioPorKm: 21,
    tarifas: [
    ...
    caracteristicas: ['Aire acondicionado', 'Agua embotellada'],
    popular: false,
  ...
  },
  {
    ...
    descripcion: 'Suburban, Yukon, Expedition o similar',
    capacidadPasajeros: 6,
    capacidadEquipaje: 8,
    imagen: '/assets/autos/suburban.png',
    kmMinimo: 20,
    precioPorKm: 40,
    tarifas: [
    ...
    caracteristicas: ['Asientos de piel', 'WiFi disponible', 'Agua embotellada', 'Ideal para familias'],
    popular: true,
    disponibleReservacion: true,
  },
  {
    id: 'minivan',
    nombre: 'Minivan',
    descripcion: 'Honda Odyssey, Toyota Sienna, Kia Sedona o similar',
    capacidadPasajeros: 6,
    capacidadEquipaje: 8,
    imagen: '/assets/autos/van.png',
    kmMinimo: 20,
    precioPorKm: 32,
    tarifas: [
    ...
    caracteristicas: ['Espacio amplio', 'Agua embotellada', 'Ideal grupos pequeños'],
    popular: false,
    disponibleReservacion: true,
  },
  {
    id: 'hiace',
    nombre: 'Toyota Hiace',
    descripcion: 'Toyota Hiace, Nissan Urvan, Ford Tránsito o similar',
    capacidadPasajeros: 12,
    capacidadEquipaje: 10,
    imagen: '/assets/autos/Hiace.png',
    kmMinimo: 20,
    precioPorKm: 52,
    tarifas: [
  ...
  },
  {
    ...
    descripcion: 'Mercedes Benz Sprinter, Volkswagen Crafter, Ford Tránsito o similar',
    capacidadPasajeros: 20,
    capacidadEquipaje: 20,
    imagen: '/assets/autos/sprinter.png',
    kmMinimo: 50,
    precioPorKm: 75,
    tarifas: [
